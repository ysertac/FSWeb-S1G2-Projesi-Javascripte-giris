...
console.log(feetDonusturucu(500));
...
function sesliHarfSayaci(a) {
  ...
  for (let i = 0; i < a.length; i++) {
    if (
      myArray[i].includes("a") ||
      myArray[i].includes("e") ||
      myArray[i].includes("ı") ||
      myArray[i].includes("i") ||
      myArray[i].includes("o") ||
      myArray[i].includes("ö") ||
      myArray[i].includes("u") ||
      myArray[i].includes("ü") ||
      myArray[i].includes("A") ||
      myArray[i].includes("E") ||
      myArray[i].includes("I") ||
      myArray[i].includes("İ") ||
      myArray[i].includes("O") ||
      myArray[i].includes("Ö") ||
      myArray[i].includes("U") ||
      myArray[i].includes("Ü")
...
console.log(sesliHarfSayaci("ayça"));
